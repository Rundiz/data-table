...
<html>
    <head>
        <meta charset="utf-8">
        <title>DataTable - test full options</title>
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <link rel="stylesheet" href="../_css-reset.css">
        <link rel="stylesheet" href="../_basic-css.css">
        <link rel="stylesheet" href="../_rundiz-data-table.css">
        <link rel="stylesheet" href="extra-table-controls.css">
        <link rel="stylesheet" href="full-options.css">
    </head>
    <body>
        <h1>DataTable - Test full options</h1>
